...
char server[] = "arduino-simple-websocket-1.jerteach.repl.co";    // name address for Google (using DNS)
...
void setup() {
  ...
  if (client.connect(server, 443)) {
    ...
    client.println("Host: arduino-simple-websocket-1.jerteach.repl.co");
